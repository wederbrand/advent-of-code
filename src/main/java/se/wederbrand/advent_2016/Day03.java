...
public class Day03 {
	public static void main(String[] args) {
		String input = "  810  679   10\n" +
			...
			"   68  744  665\n" +
			"  919  923  873";
		System.out.println(new Day03().part1(input));
		System.out.println(new Day03().part2(input));
	}
	...
	private int part2(String input) {
		...
		while (scanner.hasNextInt()) {
			...
			sides1[0] = scanner.nextInt();
			sides2[0] = scanner.nextInt();
			sides3[0] = scanner.nextInt();
			sides1[1] = scanner.nextInt();
			sides2[1] = scanner.nextInt();
			sides3[1] = scanner.nextInt();
			sides1[2] = scanner.nextInt();
			sides2[2] = scanner.nextInt();
			sides3[2] = scanner.nextInt();
			Arrays.sort(sides1);
			Arrays.sort(sides2);
			Arrays.sort(sides3);
