...
public class Day12Test {
	private static final String INPUT = "0 <-> 480, 1750\n" +
	...
	public void testPart1() {
		assertEquals(6, new Day12().part1( "0 <-> 2\n" +
			"1 <-> 1\n" +
			"2 <-> 0, 3, 4\n" +
			"3 <-> 2, 4\n" +
			"4 <-> 2, 3, 6\n" +
	...
	public void testPart2() {
		assertEquals(2, new Day12().part2( "0 <-> 2\n" +
			"1 <-> 1\n" +
			"2 <-> 0, 3, 4\n" +
			"3 <-> 2, 4\n" +
			"4 <-> 2, 3, 6\n" +
	...
	public void actualPart1() {
		System.out.println(new Day12().part1(INPUT));
	}

	@Test
	public void actualPart2() {
		System.out.println(new Day12().part2(INPUT));
	}
